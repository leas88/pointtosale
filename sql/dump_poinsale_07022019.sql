...
Date: 2019-02-07 19:07:30
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `app_almacen`
-- ----------------------------
DROP TABLE IF EXISTS `app_almacen`;
CREATE TABLE `app_almacen` (
  `id_almacen` int(11) NOT NULL AUTO_INCREMENT,
  `nombre_almacen` varchar(100) NOT NULL,
  `cve_almacen` char(30) NOT NULL,
  `latitud` double DEFAULT NULL,
  `longitud` varchar(255) DEFAULT NULL,
  `cve_asentamiento` char(10) NOT NULL,
  `calle` varchar(255) DEFAULT NULL,
  `num_int` varchar(20) DEFAULT NULL,
  `num_ext` varchar(20) DEFAULT NULL,
  `almacen_padre` int(11) DEFAULT NULL,
  `id_user_registro` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_almacen`),
  KEY `almacen_padre` (`almacen_padre`),
  CONSTRAINT `fk_almacen_padre` FOREIGN KEY (`almacen_padre`) REFERENCES `app_almacen` (`id_almacen`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of app_almacen
-- ----------------------------
INSERT INTO `app_almacen` VALUES ('1', 'Almacen General', 'AG-1', null, null, '6', null, null, null, null, '1');

-- ----------------------------
-- Table structure for `app_almacen_contacto`
-- ----------------------------
DROP TABLE IF EXISTS `app_almacen_contacto`;
CREATE TABLE `app_almacen_contacto` (
  ...
  CONSTRAINT `fk_almacen_contac` FOREIGN KEY (`id_almacen`) REFERENCES `app_almacen` (`id_almacen`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of app_almacen_contacto
-- ----------------------------

-- ----------------------------
-- Table structure for `app_almacen_producto`
-- ----------------------------
DROP TABLE IF EXISTS `app_almacen_producto`;
CREATE TABLE `app_almacen_producto` (
  `id_almacen_producto` int(11) NOT NULL,
  `id_almacen` int(11) NOT NULL,
  `id_producto` int(11) DEFAULT NULL,
  `cantidad` int(11) DEFAULT NULL,
  `precio_unitario` int(11) DEFAULT NULL,
  `activo` bit(1) DEFAULT NULL,
  `precio_mayoreo` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_almacen_producto`),
  KEY `fk_almacenes` (`id_almacen`),
  CONSTRAINT `fk_almacenes` FOREIGN KEY (`id_almacen`) REFERENCES `app_almacen` (`id_almacen`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of app_almacen_producto
-- ----------------------------
